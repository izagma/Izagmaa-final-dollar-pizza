    ...
    <div className="Veggie col-4">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">You're trying to be healthy but you still can't resist pizza? Well then the veggie slice is for you! This is gult-free pizza at its finest.</p>
        </div>
